                    ...
                    <div class="card-body">
                        ...
                        <form action="calculation.php" method="post">
                            <div class="form-group mb-3">
                                ...
                                <input type="number" name="firstInt" placeholder="Enter First Int" class="form-control" required>
                            </div>
                            <div class="form-group mb-3">
                                <label>Second Integer</label>
                                <input  type="number" name="lastInt" placeholder="Enter Last Int" class="form-control" required>
                            </div>
